...
class LogFilter
{
    ...
    {       
        ...
        {
            $escapedMessage = SiteSpecific::get_mysqli_db()->escape_string($this->m_search_text);
    ...
    public function set_max_age($seconds){ $this->m_max_age = $seconds; }
    public function set_min_age($seconds){ $this->m_min_age = $seconds; }
    
        
    # Accessors
    public function get_max_age()      { return $this->m_max_age; }
    public function get_min_age()      { return $this->m_min_age; }
    public function get_alert_levels() { return array_keys($this->m_alert_levels); }
}